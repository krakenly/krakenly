#!/bin/bash
#
# Krakenly - Start Script
# Builds and starts all Krakenly services
...
echo "========================================="
echo "  Krakenly - Starting Services"
echo "========================================="
echo ""
...
if ! command -v docker-compose &> /dev/null; then
    log_error "docker-compose not found. Run ./scripts/install-prerequisites.sh first."
    exit 1
fi
